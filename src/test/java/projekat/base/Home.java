...
public class Home {
    ...
    /*public WebElement getOneCategory(String categoryName){
        if (categoryName.equalsIgnoreCase("elements")){
            return getCategoryList().get(0);
        }
        else if (categoryName.equalsIgnoreCase("forms")){
            return getCategoryList().get(1);
        }
        else if(categoryName.equalsIgnoreCase("alerts, frame & windows")){
            return getCategoryList().get(2);
        }
        else if(categoryName.equalsIgnoreCase("widgets")){
            return getCategoryList().get(3);
        }
        else if (categoryName.equalsIgnoreCase("interactions")){
            return getCategoryList().get(4);
        }
        else (categoryName.equalsIgnoreCase("book store application")){
            return getCategoryList().get(5);
        }
